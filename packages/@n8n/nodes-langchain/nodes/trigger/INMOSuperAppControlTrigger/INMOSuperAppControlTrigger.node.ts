...
export class INMOSuperAppControlTrigger extends Node {
	description: INodeTypeDescription = {
		displayName: 'INMO Super App Control Trigger',
		name: 'inmoSuperAppControlTrigger',
		icon: 'file:INMOSuperAppControlTrigger.svg',
		group: ['trigger'],
		version: [1, 1.1],
		description: 'Runs the workflow when an n8n generated webchat is submitted',
		defaults: {
			name: 'When INMO Super App Control Event is Received',
		},
		codex: {
